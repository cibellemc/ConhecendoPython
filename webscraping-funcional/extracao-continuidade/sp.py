...
for e in range(25, 26):
    ...
    # procura na página a option com o nome do estado/município
    # busca = navegador.find_element(By.XPATH, f'//option[contains(text(),"SP")]')

    # seleciona (dentro da tag select) onde o texto é o encontrado na busca
    selecao.select_by_value("SP")
    sleep(1)
    ...
    try:
        ...
        # procura na página a option com o nome do estado/município
        # busca = navegador.find_element(By.XPATH, f'//option[contains(text(),"SÃO PAULO")]')

        # seleciona (dentro da tag select) onde o texto é o encontrado na busca
        a.select_by_value("3550308")
        sleep(1)
